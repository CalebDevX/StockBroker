    ...
    <div className="flex bg-background min-h-screen">
      ...
      <div className="flex-1 md:ml-56 flex flex-col min-h-screen">
        ...
        <main className="flex-1 p-4 md:p-6 pb-24 md:pb-6 space-y-5">
          <section className="rounded-[2rem] border border-[#0ecb81]/15 bg-gradient-to-br from-[#0b0e11] via-[#121820]/70 to-[#111821] p-4 md:p-6 shadow-[0_30px_60px_-40px_rgba(14,203,129,0.65)] backdrop-blur-sm">
            <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
              <div className="space-y-2 md:space-y-4">
                ...
                <div>
                  <h1 className="text-2xl font-bold text-foreground md:text-4xl">{greeting}</h1>
                  <p className="mt-1 md:mt-3 max-w-2xl text-sm text-muted-foreground hidden sm:block">
          ...
          <section className="overflow-x-auto -mx-4 px-4 md:mx-0 md:px-0 pb-1">
            <div className="flex gap-3 md:grid md:grid-cols-3 md:gap-4">
              <div className="rounded-[2rem] border border-[#0ecb81]/15 bg-[#0b0e11]/80 p-5 shadow-[0_20px_40px_-30px_rgba(14,203,129,0.6)] min-w-[72vw] sm:min-w-0">
              ...
              <div className="rounded-[2rem] border border-[#0ecb81]/15 bg-[#0b0e11]/80 p-5 shadow-[0_20px_40px_-30px_rgba(14,203,129,0.6)] min-w-[72vw] sm:min-w-0">
                ...
                <p className={`mt-3 text-2xl md:text-3xl font-semibold ${pnlPct >= 0 ? 'text-[#0ecb81]' : 'text-[#f6465d]'}`}>
              ...
              <div className="rounded-[2rem] border border-[#0ecb81]/15 bg-[#0b0e11]/80 p-5 shadow-[0_20px_40px_-30px_rgba(14,203,129,0.6)] min-w-[72vw] sm:min-w-0">
                ...
                <p className="mt-3 text-2xl md:text-3xl font-semibold text-foreground">{ordersData ? openOrders : '—'}</p>
