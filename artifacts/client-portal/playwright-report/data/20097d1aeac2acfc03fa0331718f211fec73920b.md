...
- Name: accessibility.spec.ts >> Mobile drawer accessibility >> has no Axe accessibility violations when the drawer is open
- Location: tests\accessibility.spec.ts:34:3
